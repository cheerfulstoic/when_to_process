defmodule WhenToProcessWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WhenToProcessWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WhenToProcessWeb.Gettext, "errors", msg, opts)
    end
  end
